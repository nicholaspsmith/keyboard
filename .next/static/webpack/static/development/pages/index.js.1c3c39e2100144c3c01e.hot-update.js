...
var KeyStyle = styled_components__WEBPACK_IMPORTED_MODULE_10__["default"].div(_templateObject());
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Key, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(KeyStyle, {
        ...
        __self: this
      }, note), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("div", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 78
        },
...
function (_Component2) {
  ...
  function Keyboard() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_1__["default"])(_this), "renderOctave", function (octave, num) {
      ...
      console.log(keys);
      console.log(octave[keys[0]]); // return keys.map(name => octave[name])

      return 'dum'; // return keys.map(name => <Key note={octave[name]} name={name} octave={num} />)
    });
...
//# sourceMappingURL=index.js.1c3c39e2100144c3c01e.hot-update.js.map